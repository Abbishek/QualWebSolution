...
public partial class _Default : System.Web.UI.Page
{
    ...
    private void GeneratePage()
    {
        ...
        {
            TempStr += "<div class=\"animated bounceIn go col-lg-" + obj1["cols"] + "\">";
            TempStr += obj1["content"];
            TempStr += "</div>";
        }
        TempStr = Util.GetTemplate("WhatWeDo").Replace("$rows$", TempStr);
        pContent += TempStr;

        // Services
        pContent += Util.GetTemplate("Services");
        ...
        //About
        pContent += Util.GetTemplate("About");

        // Values
        pContent += Util.GetTemplate("Values");
        // Contact
